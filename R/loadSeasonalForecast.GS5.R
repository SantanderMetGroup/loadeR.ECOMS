loadSeasonalForecast.GS5 = function(var, gds, grid, dic, latLon, runTimePars, time, level, aggr.d, aggr.m, derInterface) {
      foreTimePars <- getForecastTimeDomain.GS5(grid, dic, runTimePars, time, aggr.d, aggr.m)
      cube <- switch(derInterface$deriveInterface,
            none = makeSubset.GS5(grid, latLon, runTimePars, foreTimePars)
      )
      foreTimePars <- NULL      
